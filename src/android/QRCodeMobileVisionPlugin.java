...
public class QRCodeMobileVisionPlugin extends CordovaPlugin {
    public static final String TAG = "QRCodeMobileVisionPlugin";
    public static Context ctx;
    private CordovaInterface thisCordovaInterface;
    private CallbackContext thisCallbackContext;

    public QRCodeMobileVisionPlugin() {
    }

    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        super.initialize(cordova, webView);
        QRCodeMobileVisionPlugin.ctx = cordova.getActivity().getApplicationContext();
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if ("read".equals(action)) {
            Intent intent = new Intent(QRCodeMobileVisionPlugin.ctx, QRCodeActivity.class);
